...
function stlog_UpZ_NMLS!(fval::Ref{Vector{Float64}}, slope::Float64, init::Float64, Z::Ref{Matrix{Float64}}, αZ::Ref{Matrix{Float64}}, Z_saf::SAFactor,
    ...
    schurAngular_SkewSymm!(Z_saf, Z, wsp_stlog_UpZ_ret[3]; order = false, regular = false)
